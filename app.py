...
def text2story(text):
    ...
    prompt = f"Write a 50 to 100-word short story for a 3 to 10-year-old kid about: {text}. Give the story directly without any explanation. The story should be sweet and simple."
