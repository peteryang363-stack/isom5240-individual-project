...
def text2story(text):
    ...
    prompt = f"Write a short story for a 3 to 10-year-old kid about: {text}. The story should be sweet and simple. And the story should be within 50 to 100 words."
